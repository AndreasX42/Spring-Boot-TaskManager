...
public class TodoControllerIntegrationTest {
    ...
    @Autowired
    public TodoControllerIntegrationTest(TodoService todoService, TodoRepository todoRepository, TodoMapper todoMapper,
    ...
    public void testGetTodoByIdEndpoint() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/todos/{todoId}", todoDto.id()))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.priority").value(todoDto.priority().toString()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.status").value(todoDto.status().toString()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.untilDate").value(todoDto.untilDate().toString()));
    ...
    public void testGetAllTodosEndpoint() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/todos/all").param("sort", "id,desc"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.content.[0].userId").value(todoDto.userId()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.content.[0].name").value(todoDto.name()))
                .andExpect(
                        MockMvcResultMatchers.jsonPath("$.content.[0].priority").value(todoDto.priority().toString()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.content.[0].status").value(todoDto.status().toString()))
                .andExpect(
    ...
    public void testCreateTodoEndpoint() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/todos/user/{userId}", user.getId())
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.priority").value(newTodoDto.priority().toString()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.status").value(newTodoDto.status().toString()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.untilDate").value(newTodoDto.untilDate().toString()));
    }
    ...
    public void testUpdateTodoEndpoint() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/todos/user/{userId}/todo/{todoId}", user.getId(), oldTodo.id())
                .contentType(MediaType.APPLICATION_JSON)
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.priority").value(updatedTodoDto.priority().toString()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.status").value(updatedTodoDto.status().toString()))
                .andExpect(MockMvcResultMatchers.jsonPath("$.untilDate").value(updatedTodoDto.untilDate().toString()));
    }
    ...
    public void testDeleteTodoEndpoint() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.delete("/todos/user/{userId}/todo/{todoId}", user.getId(), userTodo.id()))
    ...
    public void testUpdateTodoOfOtherUserNotAllowed() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.put("/todos/user/{userId}/todo/{todoId}", oldUser.getId(), oldUserTodo.id())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(updatedTodoDtoJson))
                .andExpect(MockMvcResultMatchers.status().isForbidden());
    }
    ...
    public void testDeleteTodoOfOtherUserNotAllowed() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.delete("/todos/user/{userId}/todo/{todoId}", oldUser.getId(), oldUserTodo.id()))
                .andExpect(MockMvcResultMatchers.status().isForbidden());
